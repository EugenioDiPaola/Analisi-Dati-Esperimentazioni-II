...
void Ib_vs_Vbe () {
  ...
  for(int i = 0; i < nmisure; i++){sVbe_3[i] = Vbe_3[i] * 0.001 + 5 * 0.001;}
  ...
  //errori datasheet Amprobe 37XR-A
  float sIb_3[nmisure];
  for(int i = 0; i < nmisure; i++){sIb_3[i] = Ib_3[i] * 0.005 + 10 * 0.1;}
  ...
  for(int i = 0; i < nmisure; i++){sVbe_5[i] = Vbe_5[i] * 0.001 + 5 * 0.001;}
  ...
  //errori datasheet Amprobe 37XR-A
  float sIb_5[nmisure];
  for(int i = 0; i < nmisure; i++){sIb_5[i] = Ib_5[i] * 0.005 + 10 * 0.1;}
  ...
  for(int i = 0; i < nmisure; i++){sVbe_6e5[i] = Vbe_6e5[i] * 0.001 + 5 * 0.001;}
  ...
  for(int i = 0; i < nmisure; i++){sIb_6e5[i] = Ib_6e5[i] * 0.005 + 10 * 0.1;}
