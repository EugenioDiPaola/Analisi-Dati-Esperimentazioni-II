...
cout << "_____________________________________________________________________________________________________________________________________________________________________________________________________________ _____________________________" << endl;
cout << "_________________________________________________________________________________________________________________LEGGE DI MALUS____________________________________________________________________________________________________________" << endl;
cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    for (int i = 0; i < nmisure_malus; ++i){theta[i] = 10 * i + 10;}

    //errore di sensibilità
    float s_theta [nmisure_malus];
    for(int i = 0 ; i < nmisure_malus; i++){s_theta[i] = 1;}

    float theta_rad[nmisure_malus];
    for(int i = 0; i < nmisure_malus; i++){theta_rad[i] = theta[i] * PI / 180;}
    float s_theta_rad[nmisure_malus];
    for(int i = 0; i < nmisure_malus; i++){s_theta_rad[i] = s_theta[i] * PI / 180;}
    ...
    for (int i = 0; i < nmisure_malus; ++i){s_i_theta[i] = 0.1;}
    ...
    cout << "Chi^2:" << fz_theta_i_theta->GetChisquare() << ", number of DoF: " << fz_theta_i_theta->GetNDF() << " (Probability: " << fz_theta_i_theta->GetProb() << ")." << endl;
    cout << "-----------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;