...
vector<float> s_iConstructor(vector<float> VECTOR, float ERROR){
        ...
        for(int i = 0; i < VECTOR.size(); i++){return_vec.push_back(ERROR);}
...
vector<float> sVcConstructor(vector<float> VECTOR){
        ...
        for(auto & element: VECTOR){
            if(element < 10){return_vec.push_back(0.1);}
            if(element > 10 && element < 1e2){return_vec.push_back(0.1);}
            if(element >= 1e2 && element < 1e3){return_vec.push_back(0.1);}
            if(element >= 1e3 && element <= 1e4){return_vec.push_back(1);}
        }
...
vector<float> computeVc0AndErrorsThirdMethod(float LAMBDA, int COLOR, TCanvas * CANVAS, vector<float> V_C, vector<float> I, vector<float> S_V_C, vector<float> S_I, float ERROR){
    ...
    */
    ...
    cout << "Chi^2 :" << fz_iVc->GetChisquare() << ", number of DoF : " << fz_iVc->GetNDF() << " (Probability : " << fz_iVc->GetProb() << ")." << endl;
    cout << "--------------------------------------------------------------------------------------------------------------------------------" << endl;
    ...
    while(*it - q < 3 * ERROR){
        ...
        //cout << "index_from_end: " << index_from_end << endl;
    ...
    cout << "-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-,-.-.-.-.-.-.-,-.-.-.-.-.-.-.-.-.-.-.-.-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-" << endl;
    cout << "third method, lambda: " << LAMBDA << endl;
    vectorPrint(" ", Vc0_vec);
...
vector<float> computeVc0AndErrorsSecondMethod(float LAMBDA, int COLOR, TCanvas * CANVAS, vector<float> V_C, vector<float> I){//scambiare Vc con i
    ...
    cout << "Chi^2 :" << fzVc_i->GetChisquare() << ", number of DoF : " << fzVc_i->GetNDF() << " (Probability : " << fzVc_i->GetProb() << ")." << endl;
    cout << "--------------------------------------------------------------------------------------------------------------------------------" << endl;

    vector<float> return_vec {(float)fzVc_i->GetParameter(0), (float)fzVc_i->GetParError(0)};

    cout << "-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-,-.-.-.-.-.-.-,-.-.-.-.-.-.-.-.-.-.-.-.-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-" << endl;
    cout << "second method, lambda: " << LAMBDA << endl;
    cout << "q: " << fzVc_i->GetParameter(0) << endl;
    cout << "sq: " << fzVc_i->GetParError(0) << endl;
...
float computeVc0FirstMethod(float LAMBDA, int COLOR, int LINE_STYLE, TCanvas * CANVAS, TMultiGraph * MULTIGRAPH, vector<float> V_C, vector<float> I, vector<float> S_V_C, vector<float> S_I, int BEGIN_INCL, int END_INCL, int BEGIN_ORIZ, int END_ORIZ){   
    ...
    cout << "()()()()(()()()()()()()()())()()()()()()()()()()()()()(()()()()()()()()()()()()()(()()()()()()()()()()()()()(()()()()()()()()()()()()()(()()()()()()()()()()()()()(()()()()()()(" << endl;
    cout << "s_r" << fz_iVc_oriz->GetParError(0) << endl;
    cout << "s_q" << fz_iVc_incl->GetParError(0) << endl;
    cout << "s_m" << fz_iVc_incl->GetParError(1) << endl;
...
vector<float> computeVc0AndErrorsFirstMethod(int ORIGIN, int COLOR, float LAMBDA, TCanvas * CANVAS1, TCanvas * CANVAS2, vector<float> V_C, vector<float> I, vector<float> S_V_C, vector<float> S_I, int BEGIN_INCL, int END_INCL, int BEGIN_ORIZ, int END_ORIZ, float MIN, float MAX){
    ...
    cout << "-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-,-.-.-.-.-.-.-,-.-.-.-.-.-.-.-.-.-.-.-.-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-" << endl;
    cout << "first method, lambda: " << LAMBDA << endl;
    vectorPrint(" ", return_vec);
...
vector<float> computePlanckConstantAndExtractionWork(TCanvas * CANVAS1, TCanvas * CANVAS2, vector<float> COLORS, vector<float> LAMBDAS, vector<float> S_LEFT_LAMBDAS, vector<float> S_RIGHT_LAMBDAS, vector<float> V_C_0, vector<float> S_LEFT_V_C_0, vector<float> S_RIGHT_V_C_0){
    ...
    for(auto & LAMBDAS_i: LAMBDAS){nu.push_back((c / LAMBDAS_i) * 1e9);}
    for(int LAMBDAS_i = 0; LAMBDAS_i < LAMBDAS.size(); LAMBDAS_i++){s_left_nu.push_back(((c * pow(1 / LAMBDAS[LAMBDAS_i], 2) * S_LEFT_LAMBDAS[LAMBDAS_i])) * 1e9);}
    for(int LAMBDAS_i = 0; LAMBDAS_i < LAMBDAS.size(); LAMBDAS_i++){s_right_nu.push_back(((c * pow(1 / LAMBDAS[LAMBDAS_i], 2) * S_RIGHT_LAMBDAS[LAMBDAS_i])) * 1e9);}
    ...
    for(vector<float>::iterator V_C_0_it = V_C_0.begin(); V_C_0_it < V_C_0.end(); V_C_0_it++){eVc0.push_back(e * (*V_C_0_it) / 1e3);}
    for(vector<float>::iterator S_LEFT_V_C_0_it = S_LEFT_V_C_0.begin(); S_LEFT_V_C_0_it < S_LEFT_V_C_0.end(); S_LEFT_V_C_0_it++){s_left_eVc0.push_back(e * (*S_LEFT_V_C_0_it) / 1e3);}
    for(vector<float>::iterator S_RIGHT_V_C_0_it = S_RIGHT_V_C_0.begin(); S_RIGHT_V_C_0_it < S_RIGHT_V_C_0.end(); S_RIGHT_V_C_0_it++){s_right_eVc0.push_back(e * (*S_RIGHT_V_C_0_it) / 1e3);}


    cout << "eVc0 eVc0 eVc0 eVc0 eVc0 eVc0 eVc0 eVc0 eVc0 " << endl;
    ...
    cout << "Chi^2:" << fz_eVc0_nuCs1->GetChisquare() << ", number of DoF: " << fz_eVc0_nuCs1->GetNDF() << " (Probability: " << fz_eVc0_nuCs1->GetProb() << ")." << endl;
    cout << "---------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
    ...
    cout << "Chi^2:" << fz_eVc0_nuCs2->GetChisquare() << ", number of DoF: " << fz_eVc0_nuCs2->GetNDF() << " (Probability: " << fz_eVc0_nuCs2->GetProb() << ")." << endl;
    cout << "--------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
...
void planck3(){
    ...
    cout << "________________________________________________________________________________DATI GREZZI_______________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    for(float * it = begin(i551); it < end(i551); ++it){(*it) *= 1e2;}
    for(float * it = begin(i561); it < end(i561); ++it){(*it) *= 1e2;}
    for(float * it = begin(i590); it < end(i590); ++it){(*it) *= 1e2;}
    for(float * it = begin(i656); it < end(i656); ++it){(*it) *= 1e2;}
    


    //conversione in mV delle tensioni del gruppo 2
    for(float * it = begin(Vc432); it < end(Vc432); ++it){(*it) *= 1e3;}
    for(float * it = begin(Vc477); it < end(Vc477); ++it){(*it) *= 1e3;}
    for(float * it = begin(Vc552); it < end(Vc552); ++it){(*it) *= 1e3;}
    for(float * it = begin(Vc592); it < end(Vc592); ++it){(*it) *= 1e3;}
    for(float * it = begin(Vc607); it < end(Vc607); ++it){(*it) *= 1e3;}
    for(float * it = begin(Vc621); it < end(Vc621); ++it){(*it) *= 1e3;}
    for(float * it = begin(Vc639); it < end(Vc639); ++it){(*it) *= 1e3;}



    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "________________________________________________________________MANIPOLAZIONI PRELIMINARI SUI DATI GREZZI_________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________GRAFICO Vc vs i, TUTTI I LED NELLA STESSA SCALA_____________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 430 _________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 432 _________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 464 _________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 477(nm)______________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 551(nm)______________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 552(nm)______________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 561(nm)______________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 590 (nm)_____________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 592 (nm)_____________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "______________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 607 (nm)______________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_____________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 621(nm)_______________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_____________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 639(nm)_______________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_____________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 656(nm)_______________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_________________________________________________________________RICERCA DI HBAR, DATI GRUPPO 2___________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_________________________________________________________RICERCA DI HBAR, DATI GRUPPO D7, PRIMO DATASET___________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_________________________________________________________RICERCA DI HBAR, DATI GRUPPO D7, SECONDO DATASET_________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________" << endl;
