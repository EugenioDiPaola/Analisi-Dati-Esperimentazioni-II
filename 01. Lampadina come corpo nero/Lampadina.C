...
void lampadina(){
    ...
    cout << "_______________________________________________________________________________________________RESISTENZA INTERNA DI UN VOLTMETRO ANALOGICO_______________________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "Vbg_analog: (" << setprecision(7) << Vbg_analog << "+-" << sVbg_analog << ")" << "\n";
    cout << "Vag_analog: (" << setprecision(7) << Vag_analog << "+-" << sVag_analog << ")" << "\n";
    cout << "Rvolt_analog: (" << setprecision(7) << Rvolt_analog << "+-" << sRvolt_analog << ")" << "\n";
    cout << "sRvolt_analog / Rvolt_analog: (" << setprecision(7) << sRvolt_analog / Rvolt_analog << ")" << "\n";
    cout << endl;

   
	cout << "_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_______________________________________________________________________________________________RESISTENZA INTERNA DI UN VOLTMETRO DIGITALE_______________________________________________________________________________________________" << endl;
    cout << "_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "Vbg_dig: (" << setprecision(7) << Vbg_dig << "+-" << sVbg_dig<< ")" << "\n";
    cout << "Vag_dig: (" << setprecision(7) << Vag_dig << "+-" << sVag_dig << ")" << "\n";
    cout << "Rvolt_dig: (" << setprecision(7) << Rvolt_dig << "+-" << sRvolt_dig << ")" << "\n";
    cout << "sRvolt_dig / Rvolt_dig: (" << setprecision(7) << sRvolt_dig / Rvolt_dig << ")" << "\n";
    cout << endl;


	cout << "____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_______________________________________________________________________________________________RESISTENZA INTERNA DI UN AMPEROMETRO ANALOGICO_______________________________________________________________________________________________" << endl;
    cout << "____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "Vvolt_dig: (" << setprecision(7) << Vvolt_dig << "+-" << sVvolt_dig << ")" << endl;
    cout << "iamp_analog: (" << setprecision(7) << iamp_analog << "+-" << siamp_analog << ")" << endl;
    cout << "Ramp_analog: (" << setprecision(7) << Ramp_analog << "+-" << sRamp_analog << ")" << endl;
    cout << "sRamp_analog / Ramp_analog: " << setprecision(7) << sRamp_analog / Ramp_analog <<  "\n";
    cout << endl;


	cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_______________________________________________________________________________________________RESISTENZA INTERNA DI UN AMPEROMETRO DIGITALE______________________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "__________________________________________________________________________________CARATTERISTICA TENSIONE CORRENTE DI UNA LAMPADINA E LEGGE DI CORPO NERO__________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    float sVgen[nmisure];
    for (int i = 0; i < nmisure; ++i){sVgen[i] = 0.01;}
    ...
    for(int j = 0; j < nmisure; ++j){//Amprobe 37XR-A
    ...
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "________________________________________________________________________________________________________________GRAFICI DEI DATI___________________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "__________________________________________________________________________________________________________________FIT P = aR^4_____________________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "_______________________________________________________________________________________________________________FIT P = mR^q________________________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "q teorica: (" << q_teorica << "+-" << sq_teorica << ")" << endl;
    cout << "q sperimentale: (" << q_sperimentale3 << "+-" << sq_sperimentale3 << ")" << endl;

    double z3 = fabs(q_teorica - q_sperimentale3) / sqrt(pow(sq_sperimentale3,2) + pow(sq_teorica,2));
    
    cout << endl;
    if(z3 <= z_critico) cout << setprecision(5) << "z: " << z3 << " < " << z_critico << endl;
    if(z3 > z_critico) cout << setprecision(5) << "z: " << z3 << " > " << z_critico << endl;


    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________________________________________________________FIT P = P_4(R)_______________________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________________________________________________________FIT P = a(R-b)^4_____________________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________FIT I = sV^(q-1/q+1)____________________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "q teorica: (" << q_teorica << "+-" << sq_teorica << ")" << endl;
    cout << "q sperimentale: (" << q_sperimentale6 << "+-" << sq_sperimentale6 << ")" << endl;

    double z6 = fabs(q_teorica - q_sperimentale6) / sqrt(pow(sq_sperimentale6,2) + pow(sq_teorica,2));
    
    cout << endl;
    if(z6 <= z_critico) cout << setprecision(5) << "z: " << z6 << " < " << z_critico << endl;
    if(z6 > z_critico) cout << setprecision(5) << "z: " << z6 << " > " << z_critico << endl;
    ...
    out << "V (V)" << endl;
    for (auto & value : V){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << endl;

    out << "sV (V)" << endl;
    for (auto & value : sV){out << fixed << showpoint << setprecision(7) << value << endl;}   
    out << endl;

    out << "i (mA)" << endl;
    for (auto & value : i){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << endl;

    out << "si (mA)" << endl;
    for (auto & value : si){out << fixed << showpoint << setprecision(7) << value << endl;} 
    out << endl;

    out << "R (Ohm)" << endl;
    for (auto & value : R){out << fixed << showpoint << setprecision(7) << value << endl;} 
    out << endl;

    out << "sR (Ohm)" << endl;
    for (auto & value : sR){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << endl;

    out << "P (mW)" << endl;
    for (auto & value : P){out << fixed << showpoint << setprecision(7) << value << endl;} 
    out << endl;

    out << "sP (mW)" << endl;
    for (auto & value : sP){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << endl;
