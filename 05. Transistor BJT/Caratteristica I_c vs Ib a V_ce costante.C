...
void Ic_vs_Ib_Vce_costante(){
    ...
    for (int i = 0; i < nmisure; ++i){sIc_3[i] = Ic_3[i] * (0.005) + 5 * 0.1;}
    float sIb_3[nmisure];// = {10,10,10,10};
    for (int i = 0; i < nmisure; ++i){sIb_3[i] = Ic_3[i] * (0.005) + 10 * 0.1;}
    ...
    for (int i = 0; i < nmisure; ++i){sIc_5[i] = Ic_5[i] * (0.005) + 5 * 0.1;}
    ...
    for (int i = 0; i < nmisure; ++i){sIc_6[i] = Ic_6[i] * (0.005) + 5 * 0.1;}
    float sIb_6[nmisure];// = {10,10,10,10};
    for (int i = 0; i < nmisure; ++i){sIb_6[i] = Ib_6[i] * (0.005) + 10 * 0.1;}
