...
void led(){
    ...
    //errore di sensibilità dell'Amprobe 37XR-A
    float sVd[nmisure];
    for(int i = 0; i < nmisure; i++){sVd[i] = 0.001;}//{sVd[i] = 0.001 * Vd[i] + 5 * 0.001;};
    float sVd1[nmisure];
    for(int i = 0; i < nmisure1; i++){sVd1[i] = 0.001;}//{sVd1[i] = 0.001 * Vd1[i] + 5 * 0.001;};

    //mA
    //errore di sensibilità dell'Amprobe 37XR-A
    float sId[nmisure];
    for(int i = 0; i < nmisure; i++){
        if(Id[i] < 1){sId[i] = 0.001;}//{sId[i] = 0.005 * Id[i] + 10 * 0.001;}; //[0-1(mA)]
        if(Id[i] >= 1){sId[i] = 0.001;} // {sId[i] = 0.005 * Id[i] +  5 * 0.001;}; //[1(mA)-400(mA)]
    };
    float sId1[nmisure];
    for(int i = 0; i < nmisure1; i++){
        if(Id[i] < 1){sId[i] = 0.001;}//if(Id1[i] < 1){sId1[i] = 0.005 * Id1[i] + 10 * 0.001;}; //[0-1(mA)]
        if(Id[i] >= 1){sId[i] = 0.001;}//if(Id1[i] >= 1) {sId1[i] = 0.005 * Id1[i] +  5 * 0.001;}; //[1(mA)-400(mA)]
    };
