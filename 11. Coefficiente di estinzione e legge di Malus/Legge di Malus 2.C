...
void estinzione()
{
	...
	std::cout << "_______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_________________________________________________________________________________________________________________COEFFICIENTE DI ESTINZIONE SUCCO DI FRUTTA____________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	for(int i = 0; i < nmisure_succo; ++i)
	{
		D_succo[i] = d_succo[i] - delta_becher + 0.5;
	} //0.5 è la parte non graduata della squadra
	float s_D_succo[nmisure_succo];
	for(int i = 0; i < nmisure_succo; ++i)
	{
		s_D_succo[i] = sqrt(pow(s_d_succo[i], 2) + pow(s_delta_becher, 2));
	}
	...
	for(int i = 0; i < nmisure_succo; ++i)
	{
		s_i_D_succo[i] = sqrt(pow(0.1, 2) + pow(s_fondo, 2));
	}
	...
	std::cout << "Chi^2:" << fz_i_D_succo_D_succo->GetChisquare() << ", number of DoF: " << fz_i_D_succo_D_succo->GetNDF() << " (Probability: " << fz_i_D_succo_D_succo->GetProb() << ")." << endl;
	std::cout << "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;


	std::cout << "_______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_________________________________________________________________________________________________________________COEFFICIENTE DI ESTINZIONE GINGER____________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	for(int i = 0; i < nmisure_ginger; ++i)
	{
		s_d_ginger[i] = 0.1;
	}
	...
	for(int i = 0; i < nmisure_ginger; ++i)
	{
		D_ginger[i] = d_ginger[i] - delta_becher + 0.5;
	} //0.5 è la parte non graduata della squadra
	float s_D_ginger[nmisure_ginger];
	for(int i = 0; i < nmisure_ginger; ++i)
	{
		s_D_ginger[i] = sqrt(pow(s_d_ginger[i], 2) + pow(s_delta_becher, 2));
	}
	...
	for(int i = 0; i < nmisure_ginger; ++i)
	{
		s_i_D_ginger[i] = sqrt(pow(0.1, 2) + pow(s_fondo, 2));
	}
	...
	std::cout << "Chi^2:" << fz_i_D_ginger_D_ginger->GetChisquare() << ", number of DoF: " << fz_i_D_ginger_D_ginger->GetNDF() << " (Probability: " << fz_i_D_ginger_D_ginger->GetProb() << ")." << endl;
	std::cout << "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;

	std::cout << "_______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_________________________________________________________________________________________________________________COEFFICIENTE DI ESTINZIONE COLA____________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	for(int i = 0; i < nmisure_cola; ++i)
	{
		D_cola[i] = d_cola[i] - delta_becher + 0.5;
	} //0.5 è la parte non graduata della squadra
	float s_D_cola[nmisure_cola];
	for(int i = 0; i < nmisure_cola; ++i)
	{
		s_D_cola[i] = sqrt(pow(s_d_cola[i], 2) + pow(s_delta_becher, 2));
	}
	...
	for(int i = 0; i < nmisure_cola; ++i)
	{
		s_i_D_cola[i] = sqrt(pow(0.1, 2) + pow(s_fondo, 2));
	}
	...
	std::cout << "Chi^2:" << fz_i_D_cola_D_cola->GetChisquare() << ", number of DoF: " << fz_i_D_cola_D_cola->GetNDF() << " (Probability: " << fz_i_D_cola_D_cola->GetProb() << ")." << endl;
	std::cout << "-----------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
}
