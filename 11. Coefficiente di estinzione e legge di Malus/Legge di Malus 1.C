...
void malus1()
{
	...
	std::cout << "__________________________________________________________________________________________________LEGGE DI MALUS SENZA LAMINA QUARTO D'ONDA_______________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	for(int i = 0; i < nmisure_malus1; ++i)
	{
		theta1[i] = 10 * i;
	}
	...
	std::cout << "guess_par0_malus1: " << guess_par0_malus1 << endl;
	std::cout << "guess_par1_malus1: " << guess_par1_malus1 << endl;
	std::cout << "guess_par2_malus1: " << guess_par2_malus1 << endl;
	...
	std::cout << "Chi^2:" << fz_theta_i_theta1->GetChisquare() << ", number of DoF: " << fz_theta_i_theta1->GetNDF() << " (Probability: " << fz_theta_i_theta1->GetProb() << ")." << endl;
	std::cout << "--------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
	...
	std::cout << "guess_par0_malus11: " << guess_par0_malus11 << endl;
	std::cout << "guess_par1_malus11: " << guess_par1_malus11 << endl;
	...
	std::cout << "Chi^2:" << fz_theta_i_theta11->GetChisquare() << ", number of DoF: " << fz_theta_i_theta11->GetNDF() << " (Probability: " << fz_theta_i_theta11->GetProb() << ")." << endl;
	std::cout << "-----------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;


	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "____________________________________________________________________________________________________LEGGE DI MALUS CON LAMINA QUARTO D'ONDA_______________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	for(int i = 0; i < nmisure_malus2; ++i)
	{
		theta2[i] = 10 * i;
	}
	...
	std::cout << "guess_par0_malus2: " << guess_par0_malus2 << endl;
	std::cout << "guess_par1_malus2: " << guess_par1_malus2 << endl;
	std::cout << "guess_par2_malus2: " << guess_par2_malus2 << endl;
	...
	std::cout << "Chi^2:" << fz_theta_i_theta2->GetChisquare() << ", number of DoF: " << fz_theta_i_theta2->GetNDF() << " (Probability: " << fz_theta_i_theta2->GetProb() << ")." << endl;
	std::cout << "--------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
	...
	std::cout << "guess_par0_malus22: " << guess_par0_malus22 << endl;
	std::cout << "guess_par1_malus22: " << guess_par1_malus22 << endl;
	std::cout << "guess_par2_malus22: " << guess_par2_malus22 << endl;
	...
	std::cout << "Chi^2:" << fz_theta_i_theta22->GetChisquare() << ", number of DoF: " << fz_theta_i_theta22->GetNDF() << " (Probability: " << fz_theta_i_theta22->GetProb() << ")." << endl;
	std::cout << "-----------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
