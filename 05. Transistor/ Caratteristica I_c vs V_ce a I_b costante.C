//ma quel '..._fit' nei nome dei grafic serve a qualcosa o possso toglierlo?
...
//dati a Ib = 100 (μA) ------------------------------------------------------------------------------------------------------------------------------------
    ...
    for (int i = 0; i < nmisure; ++i){sIc_100[i] = Ic_100[i] * 0.005 + 5 * 0.1;}
...
//dati a Ib = 200 (μA) ----------------------------------------------------------------------------------------------------------------------------------
    ...
    for (int i = 0; i < nmisure; ++i){sIc_200[i] = Ic_200[i] * 0.005 + 5 * 0.1;}
...
//dati a Ib = 300 (μA) --------------------------------------------------------------------------------------------------------------------
    ...
    for (int i = 0; i < nmisure; ++i){sIc_300[i] = Ic_300[i] * 0.005 + 5 * 0.1;}
...
//dati a Ib = 400 (μA) --------------------------------------------------------------------------------------------------------------------
    ...
    for (int i = 0; i < nmisure; ++i){sIc_400[i] = Ic_400[i] * 0.005 + 5 * 0.1;}
    ...
    cout << "______________________________________________________________________________________________________________FIT A Ib = 100(microA)_______________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "Chi^2:" << funz_100->GetChisquare() << ", number of DoF: " << funz_100->GetNDF() << " (Probability: " << funz_100->GetProb() << ")." << endl;
    cout << "-----------------------------------------------------------------------------------------------------------------------------------" << endl;
    mg->Add(gVceIc_100_fit);

    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________________________________________________________FIT A Ib = 200(microA)_______________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "Chi^2:" << funz_200->GetChisquare() << ", number of DoF: " << funz_200->GetNDF() << " (Probability: " << funz_200->GetProb() << ")." << endl;
    cout << "-----------------------------------------------------------------------------------------------------------------------------------" << endl;
    mg->Add(gVceIc_200_fit);


    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________________________________________________________FIT A Ib = 300(microA)_______________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "Chi^2:" << funz_300->GetChisquare() << ", number of DoF: " << funz_300->GetNDF() << " (Probability: " << funz_300->GetProb() << ")." << endl;
    cout << "-----------------------------------------------------------------------------------------------------------------------------------" << endl;
    mg->Add(gVceIc_300_fit);

    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    cout << "______________________________________________________________________________________________________________FIT A Ib = 400(microA)_______________________________________________________________________________________________________" << endl;
    cout << "___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
    ...
    cout << "Chi^2:" << funz_400->GetChisquare() << ", number of DoF: " << funz_400->GetNDF() << " (Probability: " << funz_400->GetProb() << ")." << endl;
    cout << "-----------------------------------------------------------------------------------------------------------------------------------" << endl;
    ...
    out << "Vce_100 (V)" << endl;
    for (auto& value : Vce_100){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "Vce_200 (V)" << endl;
    for (auto& value : Vce_200){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "Vce_300 (V)" << endl;
    for (auto& value : Vce_300){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "Vce_400 (V)" << endl;
    for (auto& value : Vce_400){out << fixed << showpoint << setprecision(7) << value << endl;}   


    out << "sVce_100 (V)" << endl;
    for (auto& value : sVce_100){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "sVce_200 (V)" << endl;
    for (auto& value : sVce_200){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "sVce_300 (V)" << endl;
    for (auto& value : sVce_300){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "sVce_400 (V)" << endl;
    for (auto& value : sVce_400){out << fixed << showpoint << setprecision(7) << value << endl;}  


    out << "Ic_100 (mA)" << endl;
    for (auto& value : Ic_100){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "Ic_200 (mA)" << endl;
    for (auto& value : Ic_200){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "Ic_300 (mA)" << endl;
    for (auto& value : Ic_300){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "Ic_400 (mA)" << endl;
    for (auto& value : Ic_400){out << fixed << showpoint << setprecision(7) << value << endl;}
    

    out << "sIc_100 (mA)" << endl;
    for (auto& value : sIc_100){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "sIc_200 (mA)" << endl;
    for (auto& value : sIc_200){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "sIc_300 (mA)" << endl;
    for (auto& value : sIc_300){out << fixed << showpoint << setprecision(7) << value << endl;}
    out << "sIc_400 (mA)" << endl;
    for (auto& value : sIc_400){out << fixed << showpoint << setprecision(7) << value << endl;}
