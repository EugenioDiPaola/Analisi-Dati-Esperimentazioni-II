...
//conversione in mV
    ...
    for(int i = 0; i < i432_vec.size(); i++){s_i432_vec.push_back(0.00001);}

    vector<float> s_Vc432_vec = vector<float>();
    for(auto & element: Vc432_vec){
        if(element < 10){s_i432_vec.push_back(0.1);}
        if(element > 10 && element < 100){s_i432_vec.push_back(0.1);}
        if(element >= 100 && element < 1000){s_i432_vec.push_back(0.1);}
        if(element >= 10000 && element <= 10000){s_i432_vec.push_back(1);}
    }
...
//------------------------------
   ...
   vector<float> Vc607_vec(std::begin(Vc607), std::end(Vc607));
    ...
    for(int i = 0; i < i607_vec.size(); i++){s_i607_vec.push_back(0.00001);}

    vector<float> s_Vc607_vec = vector<float>();
    for(auto & element: Vc607_vec){
        if(element < 10){s_i607_vec.push_back(0.1);}
        if(element > 10 && element < 100){s_i607_vec.push_back(0.1);}
        if(element >= 100 && element < 1000){s_i607_vec.push_back(0.1);}
        if(element >= 10000 && element <= 10000){s_i607_vec.push_back(1);}
    }
...
//---------------------------------
    ...
    for(int i = 0; i < i592_vec.size(); i++){s_i592_vec.push_back(0.00001);}

    vector<float> s_Vc592_vec = vector<float>();
    for(auto & element: Vc592_vec){
        if(element < 10){s_i592_vec.push_back(0.1);}
        if(element > 10 && element < 100){s_i592_vec.push_back(0.1);}
        if(element >= 100 && element < 1000){s_i592_vec.push_back(0.1);}
        if(element >= 10000 && element <= 10000){s_i592_vec.push_back(1);}
    }
...
//---------------------------------
    ...
    for(int i = 0; i < i639_vec.size(); i++){s_i639_vec.push_back(0.00001);}

    vector<float> s_Vc639_vec = vector<float>();
    for(auto & element: Vc639_vec){
        if(element < 10){s_i639_vec.push_back(0.1);}
        if(element > 10 && element < 100){s_i639_vec.push_back(0.1);}
        if(element >= 100 && element < 1000){s_i639_vec.push_back(0.1);}
        if(element >= 10000 && element <= 10000){s_i639_vec.push_back(1);}
    }
...
//-----------------------
    ...
    for(int i = 0; i < i621_vec.size(); i++){s_i621_vec.push_back(0.00001);}

    vector<float> s_Vc621_vec = vector<float>();
    for(auto & element: Vc621_vec){
        if(element < 10){s_i621_vec.push_back(0.1);}
        if(element > 10 && element < 100){s_i621_vec.push_back(0.1);}
        if(element >= 100 && element < 1000){s_i621_vec.push_back(0.1);}
        if(element >= 10000 && element <= 10000){s_i621_vec.push_back(1);}
    }
    ...
    for(int i = 0; i < i552_vec.size(); i++){s_i552_vec.push_back(0.00001);}

    vector<float> s_Vc552_vec = vector<float>();
    for(auto & element: Vc552_vec){
        if(element < 10){s_i552_vec.push_back(0.1);}
        if(element > 10 && element < 100){s_i552_vec.push_back(0.1);}
        if(element >= 100 && element < 1000){s_i552_vec.push_back(0.1);}
        if(element >= 10000 && element <= 10000){s_i552_vec.push_back(1);}
...
//---------------------------------
    ...
    for(int i = 0; i < i477_vec.size(); i++){s_i477_vec.push_back(0.00001);}

    vector<float> s_Vc477_vec = vector<float>();
    for(auto & element: Vc477_vec){
        if(element < 10){s_i477_vec.push_back(0.1);}
        if(element > 10 && element < 100){s_i477_vec.push_back(0.1);}
        if(element >= 100 && element < 1000){s_i477_vec.push_back(0.1);}
        if(element >= 10000 && element <= 10000){s_i477_vec.push_back(1);}
