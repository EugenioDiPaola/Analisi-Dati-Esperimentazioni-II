...
int planck2(){
    ...
    for(int i = 0; i < i430_vec.size(); i++){s_i430_vec.push_back(0.00001);}

    vector<float> s_Vc430_vec = vector<float>();
    for(auto & element: Vc430_vec){
    	if(element < 10){s_i430_vec.push_back(0.1);}
    	if(element > 10 && element < 100){s_i430_vec.push_back(0.1);}
		if(element >= 100 && element < 1000){s_i430_vec.push_back(0.1);}
		if(element >= 10000 && element <= 10000){s_i430_vec.push_back(1);}
    }
    ...
    for(int i = 0; i < i464_vec.size(); i++){s_i464_vec.push_back(0.00001);}

    vector<float> s_Vc464_vec = vector<float>();
    for(auto & element: Vc464_vec){
    	if(element < 10){s_i464_vec.push_back(0.1);}
    	if(element > 10 && element < 100){s_i464_vec.push_back(0.1);}
		if(element >= 100 && element < 1000){s_i464_vec.push_back(0.1);}
		if(element >= 10000 && element <= 10000){s_i464_vec.push_back(1);}
    }
    ...
    for(int i = 0; i < i551_vec.size(); i++){s_i551_vec.push_back(0.00001);}

    vector<float> s_Vc551_vec = vector<float>();
    for(auto & element: Vc551_vec){
    	if(element < 10){s_i551_vec.push_back(0.1);}
    	if(element > 10 && element < 100){s_i551_vec.push_back(0.1);}
		if(element >= 100 && element < 1000){s_i551_vec.push_back(0.1);}
		if(element >= 10000 && element <= 10000){s_i551_vec.push_back(1);}
    }
    ...
    for(int i = 0; i < i561_vec.size(); i++){s_i561_vec.push_back(0.00001);}

    vector<float> s_Vc561_vec = vector<float>();
    for(auto & element: Vc561_vec){
    	if(element < 10){s_i561_vec.push_back(0.1);}
    	if(element > 10 && element < 100){s_i561_vec.push_back(0.1);}
		if(element >= 100 && element < 1000){s_i561_vec.push_back(0.1);}
		if(element >= 10000 && element <= 10000){s_i561_vec.push_back(1);}
    }
    ...
    for(int i = 0; i < i590_vec.size(); i++){s_i590_vec.push_back(0.00001);}

    vector<float> s_Vc590_vec = vector<float>();
    for(auto & element: Vc590_vec){
    	if(element < 10){s_i590_vec.push_back(0.1);}
    	if(element > 10 && element < 100){s_i590_vec.push_back(0.1);}
		if(element >= 100 && element < 1000){s_i590_vec.push_back(0.1);}
		if(element >= 10000 && element <= 10000){s_i590_vec.push_back(1);}
    }
    ...
    for(int i = 0; i < i656_vec.size(); i++){s_i656_vec.push_back(0.00001);}

    vector<float> s_Vc656_vec = vector<float>();
    for(auto & element: Vc656_vec){
    	if(element < 10){s_i656_vec.push_back(0.1);}
    	if(element > 10 && element < 100){s_i656_vec.push_back(0.1);}
		if(element >= 100 && element < 1000){s_i656_vec.push_back(0.1);}
		if(element >= 10000 && element <= 10000){s_i656_vec.push_back(1);}
    }
