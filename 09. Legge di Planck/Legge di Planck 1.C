...
vector<float> computeVc0AndErrors(int ORIGIN, float LAMBDA, vector<float> V_C, vector<float> I, int BEGIN_INCL, int END_INCL, int BEGIN_ORIZ, int END_ORIZ)
{
	...
	for(const float & x : V_C)
	{
		if(x >= 0 && x < 10)
		{
			sVc.push_back(fabs(x * 0.001 + 5 * 0.001));
		}
		if(x >= 10 && x < 1e2)
		{
			sVc.push_back(fabs(x * 0.001 + 5 * 0.01));
		}
		if(x >= 1e2 && x < 1e3)
		{
			sVc.push_back(fabs(x * 0.001 + 5 * 0.1));
		}
		if(x >= 1e3 && x < 1e4)
		{
			sVc.push_back(fabs(x * 0.001 + 5 * 1));
		}
	}
...
vector<float> computePlanckConstantAndIonizationPotential(vector<float> LAMBDA, vector<float> S_LEFT_LAMBDA, vector<float> S_RIGHT_LAMBDA, vector<float> V_C_0, vector<float> S_LEFT_V_C_0, vector<float> S_RIGHT_V_C_0)
{
	...
	{
		nu_Hz.push_back((c / LAMBDA_i) * 1e9);
	}
	for(int LAMBDA_i = 0; LAMBDA_i < LAMBDA.size(); LAMBDA_i++)
	{
		s_nu_left_Hz.push_back(((c * pow(1 / LAMBDA[LAMBDA_i], 2) * S_LEFT_LAMBDA[LAMBDA_i])) * 1e9);
	}
	for(int LAMBDA_i = 0; LAMBDA_i < LAMBDA.size(); LAMBDA_i++)
	{
		s_nu_right_Hz.push_back(((c * pow(1 / LAMBDA[LAMBDA_i], 2) * S_RIGHT_LAMBDA[LAMBDA_i])) * 1e9);
	}
	...
	for(auto & x : V_C_0)
	{
		eVc0_J.push_back(e * x * conversion_const_mVC_to_J);
	}
	for(auto & x : S_LEFT_V_C_0)
	{
		s_left_eVc0_J.push_back(e * x * conversion_const_mVC_to_J);
	}
	for(auto & x : S_RIGHT_V_C_0)
	{
		s_right_eVc0_J.push_back(e * x * conversion_const_mVC_to_J);
	}
	...
	std::cout << "Chi^2:" << fz_eVc0_J_nu_Hz->GetChisquare() << ", number of DoF: " << fz_eVc0_J_nu_Hz->GetNDF() << " (Probability: " << fz_eVc0_J_nu_Hz->GetProb() << ")." << endl;
	std::cout << "--------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
	...
	for(auto & LAMBDA_i : LAMBDA)
	{
		nu_THz.push_back((c / LAMBDA_i) / 1e3);
	}
	for(int LAMBDA_i = 0; LAMBDA_i < LAMBDA.size(); LAMBDA_i++)
	{
		s_nu_left_THz.push_back(((c * pow(1 / LAMBDA[LAMBDA_i], 2) * S_LEFT_LAMBDA[LAMBDA_i])) / 1e3);
	}
	for(int LAMBDA_i = 0; LAMBDA_i < LAMBDA.size(); LAMBDA_i++)
	{
		s_nu_right_THz.push_back(((c * pow(1 / LAMBDA[LAMBDA_i], 2) * S_RIGHT_LAMBDA[LAMBDA_i])) / 1e3);
	}
	...
	for(auto & x : V_C_0)
	{
		eVc0_eV.push_back(e * x * conversion_const_mVC_to_eV);
	}
	for(auto & x : S_LEFT_V_C_0)
	{
		s_left_eVc0_eV.push_back(e * x * conversion_const_mVC_to_eV);
	}
	for(auto & x : S_RIGHT_V_C_0)
	{
		s_right_eVc0_eV.push_back(e * x * conversion_const_mVC_to_eV);
	}
	...
	std::cout << "Chi^2:" << fz_eVc0_eV_nu_THz->GetChisquare() << ", number of DoF: " << fz_eVc0_eV_nu_THz->GetNDF() << " (Probability: " << fz_eVc0_eV_nu_THz->GetProb() << ")." << endl;
	std::cout << "--------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
...
void planck()
{
	...
	std::cout << "_______________________________________________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 430 (nm)____________________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	std::cout << "Vc0_430: " << endl << Vc0_430[0] << endl << Vc0_430[1] << endl << Vc0_430[2] << endl;


	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 464 (nm)____________________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	std::cout << "Vc0_464: " << endl << Vc0_464[0] << endl << Vc0_464[1] << endl << Vc0_464[2] << endl;


	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 540 (nm)____________________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	std::cout << "Vc0_540: " << endl << Vc0_540[0] << endl << Vc0_540[1] << endl << Vc0_540[2] << endl;


	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 561(nm)____________________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	std::cout << "Vc0_561: " << endl << Vc0_561[0] << endl << Vc0_561[1] << endl << Vc0_561[2] << endl;


	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 590(nm)____________________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	std::cout << "Vc0_590: " << endl << Vc0_590[0] << endl << Vc0_590[1] << endl << Vc0_590[2] << endl;


	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	std::cout << "_______________________________________________________________________________________________RICERCA DI Vc0, LED A LAMBDA = 656(nm)____________________________________________________________________________________________________" << endl;
	std::cout << "__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
	...
	std::cout << "Vc0_656: " << endl << Vc0_656[0] << endl << Vc0_656[1] << endl << Vc0_656[2] << endl;
	...
	std::cout << "costante di Planck: (" << planck_constant_and_ionization_potential[0] << " +- " << planck_constant_and_ionization_potential[1] << ") Js" << endl;
	std::cout << "potenziale di prima ionizzazione del Cesio: (" << 0 - planck_constant_and_ionization_potential[2] / 1.602e-19 << " +- " << planck_constant_and_ionization_potential[3] / 1.602e-19 << ") meV" << endl;
